...
template UXS_EXPORT dynbuffer& adjust_string(dynbuffer&, uxs::span<const char>, fmt_state&);
}  // namespace fmt
...
namespace fmt {
template UXS_EXPORT wunlimbuf_appender& adjust_string(wunlimbuf_appender&, uxs::span<const wchar_t>, fmt_state&);
template UXS_EXPORT wlimbuf_appender& adjust_string(wlimbuf_appender&, uxs::span<const wchar_t>, fmt_state&);
template UXS_EXPORT wdynbuffer& adjust_string(wdynbuffer&, uxs::span<const wchar_t>, fmt_state&);
}  // namespace fmt
