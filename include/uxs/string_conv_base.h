...
enum class fmt_flags : unsigned {
    ...
    hex,
    character,
    base_field = est::genmask(2, 0),
    uppercase = est::bit(3),
    fixed = 1 * est::bit(4),
    scientific = 2 * est::bit(4),
    general = 3 * est::bit(4),
    float_field = est::genmask(5, 4),
    sign_neg = 1 * est::bit(6),
    sign_pos = 2 * est::bit(6),
    sign_align = 3 * est::bit(6),
    sign_field = est::genmask(7, 6),
    left = 1 * est::bit(8),
    right = 2 * est::bit(8),
    internal = 3 * est::bit(8),
    adjust_field = est::genmask(9, 8),
    leading_zeroes = est::bit(10),
    alternate = est::bit(11),
    localize = est::bit(12),
    debug_format = est::bit(13),
    mandatory_frac = est::bit(14),
    throw_on_inf_nan = est::bit(15),
};
